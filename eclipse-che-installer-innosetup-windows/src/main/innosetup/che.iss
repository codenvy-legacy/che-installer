...
#define chePath "Z:\user\target\eclipse-che\eclipse-che-4.0.0-beta-3-SNAPSHOT"
#define mavenPath "Z:\opt\apache-maven"
#define jrePath "Z:\opt\jdk-windows"
...
Name: "maven"; Description: "Apache Maven"; Types: custom full;
...
Source: "{#mavenPath}\*"; DestDir: "{app}\tools\apache-maven"; Flags: recursesubdirs createallsubdirs ignoreversion; Components: maven
...
Source: "Z:\user\src\main\innosetup\resources\che.ico"; DestDir: "{app}"; Flags: ignoreversion
...
var
   InstallGitLocation, Folder, Maven, JRE: String;
begin
	...
	Maven := Folder + '\tools\apache-maven\';

	if DirExists(Maven) then
		begin
			AddItemToPath(Maven + 'bin');
		end;
...
begin
	...
	Wizardform.ComponentsList.Checked[3] := EnableGit;
	Wizardform.ComponentsList.ItemEnabled[3] := EnableGit;
	Wizardform.ComponentsList.Checked[4] := EnableDocker;
	Wizardform.ComponentsList.ItemEnabled[4] := EnableDocker;
end;
